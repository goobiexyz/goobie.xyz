export const manifest = {
	...
	_: {
		...
		routes: [
			...
			{
				type: 'endpoint',
				id: "api/graciebot/output-channels",
				pattern: /^\/api\/graciebot\/output-channels\/?$/,
				names: [],
				types: [],
				load: () => import('./server/entries/endpoints/api/graciebot/output-channels.js')
			},
			{
				type: 'endpoint',
				...
				names: ["fileName"],
				types: [null],
				load: () => import('./server/entries/endpoints/api/uploads/_fileName_.ts.js')
			},
			{
				type: 'endpoint',
				id: "api/posts",
				...
				names: [],
				types: [],
				load: () => import('./server/entries/endpoints/api/posts.ts.js')
			},
			{
				type: 'page',
				id: "art",
