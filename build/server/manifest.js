	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/grabble/post/index.js')
			},
			{
				type: 'endpoint',
				id: "api/grabble/get",
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/grabble/get/index.js')
			},
			{
				type: 'endpoint',
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/grabble/get/count.js')
			},
			{
				type: 'endpoint',
				...
				names: ["id"],
				types: [null],
				load: () => import('./entries/endpoints/api/grabble/get/_id_.js')
			},
			{
				type: 'page',
				id: "art",
