import { c as create_ssr_component, b as createEventDispatcher, a as add_attribute, f as compute_rest_props, d as each, v as validate_component, m as missing_component, e as escape$1, g as getContext, s as setContext } from "./index-1c4ec740.js";
/* empty css                                                  */import { I as IconButton } from "./Page-c010a59d.js";
...
const css$6 = {
  code: "img.s-hmxV9_YZvKHP{opacity:0;transition:opacity 0.1s ease-out;display:block;max-width:100%;max-height:calc(100vh - 2 * 1.5rem)}img.loaded.s-hmxV9_YZvKHP{opacity:1}.s-hmxV9_YZvKHP{}",
  map: null
};
const Image$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<img${add_attribute("src", src, 0)}${add_attribute("alt", alt, 0)} loading="${"lazy"}" class="${["s-hmxV9_YZvKHP", ""].join(" ").trim()}"${add_attribute("this", thisImage, 0)}>`;
});
const css$5 = {
  code: "div.s-gG8ZxBQ_8XJm >*:not(:first-child){margin-top:1.5rem}.s-gG8ZxBQ_8XJm{}",
  map: null
};
const SpacedDiv = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$5);
  return `<div class="${"s-gG8ZxBQ_8XJm"}">${slots.default ? slots.default({}) : ``}</div>`;
});
...
const css$4 = {
  code: 'article.s-fGeHbwCEItJu{background:white;border-radius:20px;width:768px;max-height:calc(100vh - 2 * 1.5rem);overflow:hidden;display:flex;flex-direction:column}.article-body.s-fGeHbwCEItJu{overflow-y:scroll;padding:1.5rem;--scrollbar-width:12px;scrollbar-width:var(--scrollbar-width);--mask-height:1.5rem;--mask-image-content:linear-gradient(\n      to bottom,\n      transparent,\n      black var(--mask-height),\n      black calc(100% - var(--mask-height)),\n      transparent\n  );--mask-size-content:calc(100% - var(--scrollbar-width)) 100%;--mask-image-scrollbar:linear-gradient(black, black);--mask-size-scrollbar:var(--scrollbar-width) 100%;mask-image:var(--mask-image-content), var(--mask-image-scrollbar);mask-size:var(--mask-size-content), var(--mask-size-scrollbar);mask-position:0 0, 100% 0;mask-repeat:no-repeat, no-repeat}header.s-fGeHbwCEItJu{border-bottom:1px dashed var(--black);padding-bottom:calc(1.5rem / 2)}h1.s-fGeHbwCEItJu{font-family:"urbane-bold";font-size:1.9rem}article.s-fGeHbwCEItJu h2{font-size:1.25rem}time.s-fGeHbwCEItJu{margin-top:8px;font-family:monospace;font-size:0.95rem}@media only screen and (max-width: 768px){article.s-fGeHbwCEItJu{width:auto}}.s-fGeHbwCEItJu{}',
  map: null
};
const BlogPost = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let postBody = "";
  fetch(`/posts/blog/${meta._id}.md`).then(async (response) => {
    if (response.ok) {
      postBody = await response.text();
    } else {
      postBody = "## 404";
    }
    fileFetched = true;
  ...
  return `<article class="${"s-fGeHbwCEItJu"}"><div class="${"article-body s-fGeHbwCEItJu"}">${validate_component(SpacedDiv, "SpacedDiv").$$render($$result, {}, {}, {
    default: () => {
      return `<header class="${"s-fGeHbwCEItJu"}"><h1 class="${"s-fGeHbwCEItJu"}">${escape$1(meta.title)}</h1>
      <time${add_attribute("datetime", meta.date, 0)} class="${"s-fGeHbwCEItJu"}">${escape$1(convertDate(meta.date))}</time></header>

      ${fileFetched ? `${validate_component(SvelteMarkdown, "SvelteMarkdown").$$render($$result, { source: postBody }, {}, {})}` : ``}`;
    }
  })}</div>
</article>`;
});
...
const css$3 = {
  code: ".card.s-C8RbrZLkT0Vl{display:block;background:white;border-radius:20px;padding:calc(1.5rem / 2);font-size:0;width:calc(100vw - calc(1.5rem * 2));max-width:768px;transition:0.5s opacity}.card.hide.s-C8RbrZLkT0Vl{opacity:0}iframe.s-C8RbrZLkT0Vl{border-radius:10px;aspect-ratio:16/9;width:100%}.s-C8RbrZLkT0Vl{}",
  map: null
};
const VideoCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"card " + escape$1("hide") + " s-C8RbrZLkT0Vl"}"><iframe src="${"https://www.youtube-nocookie.com/embed/" + escape$1(videoID)}" title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen class="${"s-C8RbrZLkT0Vl"}"></iframe>
</div>`;
});
var MusicCard_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: ".card.s-mEYR2ZGcGHM0{background:white;border-radius:20px;padding:calc(1.5rem / 2);width:360px;display:grid;grid-auto-flow:column;grid-template-columns:50px 1fr;grid-template-rows:auto auto;grid-row-gap:calc(1.5rem / 2);transition:0.25s opacity}.card.hide.s-mEYR2ZGcGHM0{opacity:0}.cover.s-mEYR2ZGcGHM0{grid-column:span 2;width:100%;background:red;border-radius:10px}.s-mEYR2ZGcGHM0{}",
  map: null
};
const MusicCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<script src="${"https://unpkg.com/wavesurfer.js"}" class="${"s-mEYR2ZGcGHM0"}" data-svelte="svelte-okxju7"><\/script>`, ""}



<div class="${"card " + escape$1("hide") + " s-mEYR2ZGcGHM0"}"><img class="${"cover s-mEYR2ZGcGHM0"}" src="${"/posts/music/" + escape$1(meta._id) + ".jpg"}" alt="${""}">
  <button class="${"s-mEYR2ZGcGHM0"}">Play</button>
  <div id="${"waveform"}" class="${"s-mEYR2ZGcGHM0"}"></div>
</div>`;
});
var ModalContent_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: ".content.s-9yJjHOZoQsTW{display:inline-block}.s-9yJjHOZoQsTW{}",
  map: null
};
const ModalContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"content s-9yJjHOZoQsTW"}">${post.type == "art" ? `${validate_component(Image$1, "Image").$$render($$result, {
    src: "/posts/" + post.type + "/" + post._id + ".jpg"
  }, {}, {})}` : `${post.type == "blog" ? `${validate_component(BlogPost, "BlogPost").$$render($$result, { meta: post }, {}, {})}` : `${post.type == "video" ? `${validate_component(VideoCard, "VideoCard").$$render($$result, { videoID: post.videoID }, {}, {})}` : `${post.type == "music" ? `${validate_component(MusicCard, "MusicCard").$$render($$result, { meta: post }, {}, {})}` : ``}`}`}`}
</div>`;
});
var MediaModal_svelte_svelte_type_style_lang = "";
const css = {
  code: '.modal.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{position:fixed;width:100vw;height:100vh;background:rgba(0, 0, 0, 0.75);z-index:100;opacity:0;pointer-events:none;transition:opacity 0.25s}.modal.open.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{opacity:1;pointer-events:auto}.modal-controls.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf,.modal-caption.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{z-index:200;opacity:1;transition:0.1s opacity}.modal-controls.hide.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf,.modal-caption.hide.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{opacity:0;pointer-events:none}.modal-controls.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{background:rgba(0, 0, 0, 0.75);display:inline-block;padding:6px;border-radius:100px;position:absolute;top:calc(1.5rem / 2);right:calc(1.5rem / 2)}.modal-caption.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{position:absolute;bottom:0;background:rgba(0, 0, 0, 0.8);width:100%;padding:calc(1.5rem / 2);color:white}.modal-caption.s-3S_PU4ZfLmAf .modal-title.s-3S_PU4ZfLmAf{font-family:"urbane-bold";font-size:1.4rem;display:block}.modal-caption.s-3S_PU4ZfLmAf time.s-3S_PU4ZfLmAf{display:block;font-family:mono;margin-top:6px;font-size:0.9rem}.modal-body.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{display:flex;justify-content:center;align-items:center;width:100%;height:100%}.modal-body.s-3S_PU4ZfLmAf >*{margin:1.5rem;z-index:150}@keyframes s-3S_PU4ZfLmAf-loading-icon-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}.loading-icon.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{z-index:300;width:4rem;height:4rem;pointer-events:none;position:fixed;left:50%;top:50%;margin-top:-2rem;margin-left:-2rem;animation:s-3S_PU4ZfLmAf-loading-icon-spin 2s linear infinite;opacity:1;transition:opacity 0.1s}.loading-icon.loaded.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{opacity:0}.out-click-zone.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{position:absolute;height:100vh;width:100vw;z-index:125}.s-3S_PU4ZfLmAf.s-3S_PU4ZfLmAf{}',
  map: null
};
const MediaModal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${["modal s-3S_PU4ZfLmAf", open ? "open" : ""].join(" ").trim()}"><div class="${"modal-controls " + escape$1(showControls ? "" : "hide") + " s-3S_PU4ZfLmAf"}">${validate_component(IconButton, "IconButton").$$render($$result, { type: "close", title: "Close" }, {}, {})}
    </div>

  ${post.type == "art" ? `<div class="${"modal-caption " + escape$1(showControls ? "" : "hide") + " s-3S_PU4ZfLmAf"}"><span class="${"modal-title s-3S_PU4ZfLmAf"}">${escape$1(post.title)}</span>
      <time${add_attribute("datetime", post.date, 0)} class="${"s-3S_PU4ZfLmAf"}">${escape$1(convertDate(post.date))}</time></div>` : ``}

  <img class="${["loading-icon s-3S_PU4ZfLmAf", loaded ? "loaded" : ""].join(" ").trim()}" src="${"/images/icons/loading.svg"}" alt="${"Loading"}">

  <div class="${"modal-body s-3S_PU4ZfLmAf"}">${open ? `${validate_component(ModalContent, "ModalContent").$$render($$result, { post }, {}, {})}` : ``}
    <div class="${"out-click-zone s-3S_PU4ZfLmAf"}"></div></div>


</div>`;
});
export { MediaModal as M, SpacedDiv as S, convertDate as c };
