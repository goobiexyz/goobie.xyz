import { c as create_ssr_component, h as compute_rest_props, d as each, v as validate_component, m as missing_component, e as escape$1, g as getContext, f as add_attribute, a as createEventDispatcher, s as setContext } from "./index-3ede4686.js";
import { I as Image$1 } from "./Image-de277fa9.js";
import { S as SpacedDiv } from "./SpacedDiv-6bdd6ed1.js";
import { c as convertDate } from "./convert-date-64d95c73.js";
import { I as IconButton } from "./Page-481419e6.js";
...
const css = {
  code: ".modal.svelte-1i5ninq{position:fixed;z-index:100;width:100vw;height:100vh;max-height:-moz-available;height:-webkit-fill-available;background:rgba(0, 0, 0, 0.85);pointer-events:none;opacity:0;transition:opacity 0.5s}.modal.open.svelte-1i5ninq{opacity:1;pointer-events:auto}.modal-body.svelte-1i5ninq{display:flex;justify-content:center;align-items:center;width:100%;height:100%}.modal-body.svelte-1i5ninq >*{margin:var(--margin);z-index:150}@-webkit-keyframes svelte-1i5ninq-loading-icon-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}@keyframes svelte-1i5ninq-loading-icon-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}.loading-icon.svelte-1i5ninq{z-index:300;width:4rem;height:4rem;pointer-events:none;position:fixed;left:50%;top:50%;margin-top:-2rem;margin-left:-2rem;-webkit-animation:svelte-1i5ninq-loading-icon-spin 2s linear infinite;animation:svelte-1i5ninq-loading-icon-spin 2s linear infinite}.out-click-zone.svelte-1i5ninq{position:absolute;height:100vh;max-height:-moz-available;height:-webkit-fill-available;width:100vw;z-index:125}.modal-controls.svelte-1i5ninq,.modal-caption.svelte-1i5ninq{position:absolute;z-index:200}.modal-controls.svelte-1i5ninq{bottom:var(--margin);left:var(--margin)}.modal-caption.svelte-1i5ninq{top:0;width:100%;padding:var(--margin);display:flex;justify-content:space-evenly;background:rgba(0, 0, 0, 0.85);color:white}.modal-caption-interior.svelte-1i5ninq{max-width:var(--s)}.modal-title.svelte-1i5ninq{font-family:'urbane-bold';font-size:1.4rem;display:block}.date.svelte-1i5ninq{display:block;font-family:monospace;margin-top:6px;font-size:0.9rem}.desc.svelte-1i5ninq{margin-top:var(--half-margin)}",
  map: null
};
...
<div class="${["modal svelte-1i5ninq", open ? "open" : ""].join(" ").trim()}"${add_attribute("this", modal, 0)}>${open ? `${showControls ? `<div class="${["modal-controls svelte-1i5ninq", !showControls ? "hide" : ""].join(" ").trim()}">${validate_component(IconButton, "IconButton").$$render($$result, {
    type: "back-circle",
    title: "Back",
    size: "big"
  }, {}, {})}</div>` : ``}

    ${mediaType === "art" && showControls ? `<div class="${["modal-caption svelte-1i5ninq", !showControls ? "hide" : ""].join(" ").trim()}"><div class="${"modal-caption-interior svelte-1i5ninq"}"><span class="${"modal-title svelte-1i5ninq"}">${escape$1(post.attributes.title)}</span>
          <time class="${"date svelte-1i5ninq"}"${add_attribute("datetime", post.attributes.date, 0)}>${escape$1(convertDate(post.attributes.date))}</time>
          <p class="${"desc svelte-1i5ninq"}">${escape$1(post.attributes.description)}</p></div></div>` : ``}

    ${!loaded ? `<img class="${"loading-icon svelte-1i5ninq"}" src="${"/images/icons/loading.svg"}" alt="${"Loading"}">` : ``}

    <div class="${"modal-body svelte-1i5ninq"}">${validate_component(ModalContent, "ModalContent").$$render($$result, { post }, {}, {})}
      <div class="${"out-click-zone svelte-1i5ninq"}"></div></div>` : ``}
</div>`;
});
export { MediaModal as M };
