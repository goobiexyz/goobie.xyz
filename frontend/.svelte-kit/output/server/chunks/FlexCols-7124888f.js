...
const css = {
  code: ".flex-2-col.svelte-v8aby2{display:flex;flex-wrap:wrap}.flex-2-col.svelte-v8aby2 >*{display:flex;justify-content:space-evenly;justify-items:center}",
  map: null
};
const FlexCols = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"flex-2-col svelte-v8aby2"}" style="${"row-gap: " + escape(rowGap) + "; column-gap: " + escape(colGap) + ";"}">${slots.default ? slots.default({}) : ``}
</div>`;
});
