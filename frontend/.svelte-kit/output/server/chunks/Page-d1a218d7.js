...
const css$3 = {
  code: '@keyframes svelte-jvcerg-scroll{100%{background-position-x:-60px}}@keyframes svelte-jvcerg-bouncy{50%{background-position-y:-80px}}section.svelte-jvcerg.svelte-jvcerg{overflow:auto;padding:calc(1.5rem * 4) 0}section.simple.svelte-jvcerg.svelte-jvcerg{padding:calc(1.5rem * 2) 0}section.bg-blue-stripes.svelte-jvcerg.svelte-jvcerg{background:url("/images/backgrounds/blue_stripes.png") repeat;background-attachment:fixed;animation:1s svelte-jvcerg-scroll infinite linear}section.bg-gracie.svelte-jvcerg.svelte-jvcerg{background:url("/images/backgrounds/gracie-pattern.png");background-attachment:fixed;animation:2s svelte-jvcerg-scroll infinite linear, 5s svelte-jvcerg-bouncy infinite ease-in-out}section.top-border-clouds.svelte-jvcerg.svelte-jvcerg{border-image-source:url("/images/borders/clouds.svg");border-top:3rem solid;border-image-slice:100% 0 0 0;border-image-repeat:repeat;border-image-outset:2px}.section-heading.svelte-jvcerg.svelte-jvcerg{font-size:2.5rem;font-weight:normal;font-family:"freude";text-align:center;display:table;width:100%}.section-heading.blue.svelte-jvcerg.svelte-jvcerg{color:var(--dark-blue)}.section-heading.white.svelte-jvcerg.svelte-jvcerg{color:white}.section-heading.svelte-jvcerg>span.svelte-jvcerg,.section-heading.svelte-jvcerg.svelte-jvcerg:before,.section-heading.svelte-jvcerg.svelte-jvcerg:after{display:table-cell}.section-heading.blue.svelte-jvcerg.svelte-jvcerg:before,.section-heading.blue.svelte-jvcerg.svelte-jvcerg:after{background:var(--blue)}.section-heading.white.svelte-jvcerg.svelte-jvcerg:before,.section-heading.white.svelte-jvcerg.svelte-jvcerg:after{background:white}.section-heading.black.svelte-jvcerg.svelte-jvcerg:before,.section-heading.black.svelte-jvcerg.svelte-jvcerg:after{background:var(--black)}.section-heading.svelte-jvcerg.svelte-jvcerg:before,.section-heading.svelte-jvcerg.svelte-jvcerg:after{-webkit-mask-image:url("/images/borders/blue_dot.svg");-webkit-mask-size:contain;-webkit-mask-position:center;-webkit-mask-size:10px;-webkit-mask-repeat:repeat no-repeat;mask-image:url("/images/borders/blue_dot.svg");mask-size:contain;mask-position:center;mask-size:10px;mask-repeat:space no-repeat;width:50%;content:" "}.section-heading.svelte-jvcerg>span.svelte-jvcerg{white-space:nowrap;padding:0 9px}.section-contents.svelte-jvcerg.svelte-jvcerg{padding:0 1.5rem;margin:auto;width:calc(900px - calc(1.5rem * 2))}section.svelte-jvcerg .section-body.spacing-normal.svelte-jvcerg >*{margin-top:1.5rem}section.svelte-jvcerg .section-body.spacing-double.svelte-jvcerg >*{margin-top:calc(1.5rem * 2)}section.no-heading.svelte-jvcerg .section-body.svelte-jvcerg >*:first-child{margin-top:0}@media only screen and (max-width: 900px){.section-contents.svelte-jvcerg.svelte-jvcerg{width:calc(768px - calc(1.5rem * 2))}}@media only screen and (max-width: 768px){section.svelte-jvcerg.svelte-jvcerg{padding:calc(1.5rem * 3) 0}.section-contents.svelte-jvcerg.svelte-jvcerg{width:calc(600px - calc(1.5rem * 2))}}@media only screen and (max-width: 600px){section.svelte-jvcerg.svelte-jvcerg{padding:1.5rem 0}.section-contents.svelte-jvcerg.svelte-jvcerg{width:auto}}',
  map: null
};
const Section = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section${add_attribute("id", id, 0)} class="${[
    "bg-" + escape(bg) + " top-border-" + escape(topBorder) + " svelte-jvcerg",
    (simple ? "simple" : "") + " " + (!heading ? "no-heading" : "")
  ].join(" ").trim()}"><div class="${"section-contents svelte-jvcerg"}">${heading ? `<h2 class="${"section-heading " + escape(headingColor) + " svelte-jvcerg"}"><span class="${"svelte-jvcerg"}">${escape(heading)}</span></h2>` : ``}
    <div class="${"section-body spacing-" + escape(spacing) + " svelte-jvcerg"}">${slots.default ? slots.default({}) : ``}</div></div>
</section>`;
});
