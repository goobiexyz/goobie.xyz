import { c as create_ssr_component, f as add_attribute, e as escape, v as validate_component } from "./index-0ee30357.js";
...
const css$2 = {
  code: "button.svelte-1guzmtw:hover{transform:scale(1.2)}button.svelte-1guzmtw:active{transform:scale(1)}button.svelte-1guzmtw{transition:transform 0.1s;display:block;position:relative;width:2rem;height:2rem}button.medium.svelte-1guzmtw{width:3rem;height:3rem}button.big.svelte-1guzmtw{width:4rem;height:4rem}button.svelte-1guzmtw{border:none;padding:0;margin:0;-webkit-mask-size:contain;-webkit-mask-position:center;-webkit-mask-repeat:no-repeat;mask-size:contain;mask-position:center;mask-repeat:no-repeat}button.white.svelte-1guzmtw{background:white}button.dark-blue.svelte-1guzmtw{background:var(--dark-blue)}button.logo.svelte-1guzmtw{mask-image:url('/images/icons/b_logo.svg');-webkit-mask-image:url('/images/icons/b_logo.svg')}button.twitter.svelte-1guzmtw{mask-image:url('/images/icons/b_twitter.svg');-webkit-mask-image:url('/images/icons/b_twitter.svg')}button.youtube.svelte-1guzmtw{mask-image:url('/images/icons/b_youtube.svg');-webkit-mask-image:url('/images/icons/b_youtube.svg')}button.soundcloud.svelte-1guzmtw{mask-image:url('/images/icons/b_soundcloud.svg');-webkit-mask-image:url('/images/icons/b_soundcloud.svg')}button.github.svelte-1guzmtw{mask-image:url('/images/icons/b_github.svg');-webkit-mask-image:url('/images/icons/b_github.svg')}button.close.svelte-1guzmtw{mask-image:url('/images/icons/b_close.svg');-webkit-mask-image:url('/images/icons/b_close.svg')}button.right-arrow.svelte-1guzmtw{mask-image:url('/images/icons/b_arrow_r.svg');-webkit-mask-image:url('/images/icons/b_arrow_r.svg')}button.left-arrow.svelte-1guzmtw{mask-image:url('/images/icons/b_arrow_l.svg');-webkit-mask-image:url('/images/icons/b_arrow_l.svg')}button.back-circle.svelte-1guzmtw{background:none;background-image:url('/images/icons/b_back_circle.svg')}",
  map: null
};
const IconButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="${escape(type) + " " + escape(size) + " " + escape(color) + " svelte-1guzmtw"}"${add_attribute("title", title, 0)}></button>`;
});
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="${"svelte-1kxjoq3"}">${validate_component(IconLink, "IconLink").$$render($$result, { type: "twitter" }, {}, {})}
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<header class="${"svelte-1c95d3m"}">${validate_component(IconLink, "IconLink").$$render($$result, { type: "logo", size: "medium" }, {}, {})}
