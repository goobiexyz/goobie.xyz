...
const Image = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<img${add_attribute("src", src, 0)}${add_attribute("alt", alt, 0)} loading="${"lazy"}" class="${["svelte-lcj22s", ""].join(" ").trim()}">`;
});
const css$5 = {
...
const BlogPost = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"svelte-xgnov6"}"><div class="${"article-body svelte-xgnov6"}">${validate_component(SpacedDiv, "SpacedDiv").$$render($$result, {}, {}, {
    default: () => {
      return `<header class="${"svelte-xgnov6"}"><h1 class="${"svelte-xgnov6"}">${escape(meta.title)}</h1>
      <time${add_attribute("datetime", meta.date, 0)} class="${"svelte-xgnov6"}">${escape(convertDate(meta.date))}</time></header>
...
<div class="${["modal svelte-mkmglf", open ? "open" : ""].join(" ").trim()}"${add_attribute("this", modal, 0)}><div class="${"modal-controls " + escape(showControls ? "" : "hide") + " svelte-mkmglf"}">${validate_component(IconButton, "IconButton").$$render($$result, {
    type: "back-circle",
    title: "Back",
    size: "big"
  }, {}, {})}
...
export { Image as I, MediaModal as M, SpacedDiv as S };
