import { c as create_ssr_component, h as compute_rest_props, d as each, v as validate_component, m as missing_component, e as escape$1, g as getContext, f as add_attribute, a as createEventDispatcher, s as setContext } from "./index-0ee30357.js";
import { I as Image$1 } from "./Image-e7ebf645.js";
import { S as SpacedDiv } from "./SpacedDiv-a3cc0b62.js";
import { I as IconButton } from "./Page-b367a379.js";
...
const css$4 = {
  code: "article.svelte-1k56ckj{background:white;border-radius:20px;width:768px;max-height:calc(100vh - var(--margin)*2);overflow:hidden;display:flex;flex-direction:column}.article-body.svelte-1k56ckj{overflow-y:scroll;padding:var(--margin);scrollbar-width:12px;-webkit-mask-image:linear-gradient(\n      to bottom,\n      transparent,\n      black var(--margin),\n      black calc(100% - var(--margin)),\n      transparent\n  ), linear-gradient(black, black);mask-image:linear-gradient(\n      to bottom,\n      transparent,\n      black var(--margin),\n      black calc(100% - var(--margin)),\n      transparent\n  ), linear-gradient(black, black);-webkit-mask-size:calc(100% - 12px) 100%, 12px 100%;mask-size:calc(100% - 12px) 100%, 12px 100%;-webkit-mask-position:0 0, 100% 0;mask-position:0 0, 100% 0;-webkit-mask-repeat:no-repeat, no-repeat;mask-repeat:no-repeat, no-repeat}header.svelte-1k56ckj{border-bottom:1px dashed var(--black);padding-bottom:var(--half-margin)}h1.svelte-1k56ckj{font-family:'urbane-bold';font-size:1.9rem}article.svelte-1k56ckj h2{font-size:1.25rem}time.svelte-1k56ckj{margin-top:8px;font-family:monospace;font-size:0.95rem}@media only screen and (max-width: 768px){article.svelte-1k56ckj{width:auto}}",
  map: null
};
const BlogPost = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"svelte-1k56ckj"}"><div class="${"article-body svelte-1k56ckj"}">${validate_component(SpacedDiv, "SpacedDiv").$$render($$result, {}, {}, {
    default: () => {
      return `<header class="${"svelte-1k56ckj"}"><h1 class="${"svelte-1k56ckj"}">${escape$1(meta.title)}</h1>
      <time${add_attribute("datetime", meta.date, 0)} class="${"svelte-1k56ckj"}">${escape$1(convertDate(meta.date))}</time></header>
...
const css$3 = {
  code: ".card.svelte-qmkq4k{display:block;background:white;border-radius:20px;padding:0.75rem;font-size:0;width:calc(100vw - 3rem);max-width:768px;transition:0.5s opacity}.card.hide.svelte-qmkq4k{opacity:0}iframe.svelte-qmkq4k{border-radius:10px;aspect-ratio:16/9;width:100%}",
  map: null
};
const VideoCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"card " + escape$1("hide") + " svelte-qmkq4k"}"><iframe src="${"https://www.youtube-nocookie.com/embed/" + escape$1(videoID)}" title="${"YouTube video player"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen class="${"svelte-qmkq4k"}"></iframe>
</div>`;
});
var MusicCard_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: ".card.svelte-789qdf{background:white;border-radius:20px;padding:0.75rem;width:360px;display:grid;grid-auto-flow:column;grid-template-columns:50px 1fr;grid-template-rows:auto auto;grid-row-gap:0.75rem;transition:0.25s opacity}.card.hide.svelte-789qdf{opacity:0}.cover.svelte-789qdf{grid-column:span 2;width:100%;background:red;border-radius:10px}",
  map: null
};
...
<div class="${"card " + escape$1("hide") + " svelte-789qdf"}"><img class="${"cover svelte-789qdf"}"${add_attribute("src", cover, 0)} alt="${""}">
  <button>Play</button>
  <div id="${"waveform"}"></div>
</div>`;
});
...
const css$1 = {
  code: ".content.svelte-1pwxwm4{display:inline-block}",
  map: null
};
const ModalContent = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"content svelte-1pwxwm4"}">${type == "art" ? `${validate_component(Image$1, "Image").$$render($$result, {
    src: "https://api.graciebell.art" + artImage,
    style: "max-width: 100%; max-height: calc(100vh - 2 * var(--margin));"
...
const css = {
  code: ".modal.svelte-1og3yo.svelte-1og3yo{position:fixed;width:100vw;height:100vh;max-height:-moz-available;height:-webkit-fill-available;background:rgba(0, 0, 0, 0.85);z-index:100;opacity:0;pointer-events:none;transition:opacity 0.25s}.modal.open.svelte-1og3yo.svelte-1og3yo{opacity:1;pointer-events:auto}.modal-controls.svelte-1og3yo.svelte-1og3yo,.modal-caption.svelte-1og3yo.svelte-1og3yo{z-index:200;opacity:1;transition:0.1s opacity}.modal-controls.hide.svelte-1og3yo.svelte-1og3yo,.modal-caption.hide.svelte-1og3yo.svelte-1og3yo{opacity:0;pointer-events:none}.modal-controls.svelte-1og3yo.svelte-1og3yo{position:absolute;bottom:var(--margin);left:var(--margin)}.modal-caption.svelte-1og3yo.svelte-1og3yo{display:flex;justify-content:space-evenly;position:absolute;top:0;background:rgba(0, 0, 0, 0.85);width:100%;padding:var(--margin);color:white}.modal-caption.svelte-1og3yo .modal-title.svelte-1og3yo{font-family:'urbane-bold';font-size:1.4rem;display:block}.modal-caption.svelte-1og3yo time.svelte-1og3yo{display:block;font-family:monospace;margin-top:6px;font-size:0.9rem}.modal-caption.svelte-1og3yo .desc.svelte-1og3yo{margin-top:var(--half-margin)}.modal-caption-interior.svelte-1og3yo.svelte-1og3yo{max-width:var(--s)}.modal-body.svelte-1og3yo.svelte-1og3yo{display:flex;justify-content:center;align-items:center;width:100%;height:100%}.modal-body.svelte-1og3yo >*{margin:var(--margin);z-index:150}@-webkit-keyframes svelte-1og3yo-loading-icon-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}@keyframes svelte-1og3yo-loading-icon-spin{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}.loading-icon.svelte-1og3yo.svelte-1og3yo{z-index:300;width:4rem;height:4rem;pointer-events:none;position:fixed;left:50%;top:50%;margin-top:-2rem;margin-left:-2rem;-webkit-animation:svelte-1og3yo-loading-icon-spin 2s linear infinite;animation:svelte-1og3yo-loading-icon-spin 2s linear infinite;opacity:1;transition:opacity 0.1s}.loading-icon.loaded.svelte-1og3yo.svelte-1og3yo{opacity:0}.out-click-zone.svelte-1og3yo.svelte-1og3yo{position:absolute;height:100vh;max-height:-moz-available;height:-webkit-fill-available;width:100vw;z-index:125}",
  map: null
};
...
<div class="${["modal svelte-1og3yo", open ? "open" : ""].join(" ").trim()}"${add_attribute("this", modal, 0)}><div class="${"modal-controls " + escape$1(showControls ? "" : "hide") + " svelte-1og3yo"}">${validate_component(IconButton, "IconButton").$$render($$result, {
    type: "back-circle",
    title: "Back",
    size: "big"
  }, {}, {})}</div>

  ${open ? `${post.attributes.media_type == "art" ? `<div class="${"modal-caption " + escape$1(showControls ? "" : "hide") + " svelte-1og3yo"}"><div class="${"modal-caption-interior svelte-1og3yo"}"><span class="${"modal-title svelte-1og3yo"}">${escape$1(post.attributes.title)}</span>
          <time${add_attribute("datetime", post.attributes.date, 0)} class="${"svelte-1og3yo"}">${escape$1(convertDate(post.attributes.date))}</time>
          <p class="${"desc svelte-1og3yo"}">${escape$1(post.attributes.description)}</p></div></div>` : ``}` : ``}

  <img class="${["loading-icon svelte-1og3yo", loaded ? "loaded" : ""].join(" ").trim()}" src="${"/images/icons/loading.svg"}" alt="${"Loading"}">

  <div class="${"modal-body svelte-1og3yo"}">${open ? `${validate_component(ModalContent, "ModalContent").$$render($$result, { post }, {}, {})}` : ``}
    <div class="${"out-click-zone svelte-1og3yo"}"></div></div>
</div>`;
});
export { MediaModal as M, convertDate as c };
