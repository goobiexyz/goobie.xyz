...
const css$2 = {
  code: "button.svelte-z5oo5j:hover{transform:scale(1.2)}button.svelte-z5oo5j:active{transform:scale(1)}button.svelte-z5oo5j{transition:transform 0.1s;display:block;position:relative;width:2rem;height:2rem}button.medium.svelte-z5oo5j{width:3rem;height:3rem}button.big.svelte-z5oo5j{width:4rem;height:4rem}button.svelte-z5oo5j{border:none;padding:0;margin:0;-webkit-mask-size:contain;-webkit-mask-position:center;-webkit-mask-repeat:no-repeat;mask-size:contain;mask-position:center;mask-repeat:no-repeat;background:var(--color)}button.logo.svelte-z5oo5j{mask-image:url('/images/icons/b_logo.svg');-webkit-mask-image:url('/images/icons/b_logo.svg')}button.twitter.svelte-z5oo5j{mask-image:url('/images/icons/b_twitter.svg');-webkit-mask-image:url('/images/icons/b_twitter.svg')}button.youtube.svelte-z5oo5j{mask-image:url('/images/icons/b_youtube.svg');-webkit-mask-image:url('/images/icons/b_youtube.svg')}button.soundcloud.svelte-z5oo5j{mask-image:url('/images/icons/b_soundcloud.svg');-webkit-mask-image:url('/images/icons/b_soundcloud.svg')}button.github.svelte-z5oo5j{mask-image:url('/images/icons/b_github.svg');-webkit-mask-image:url('/images/icons/b_github.svg')}button.tumblr.svelte-z5oo5j{mask-image:url('/images/icons/b_tumblr.svg');-webkit-mask-image:url('/images/icons/b_tumblr.svg')}button.spacehey.svelte-z5oo5j{mask-image:url('/images/icons/b_spacehey.svg');-webkit-mask-image:url('/images/icons/b_spacehey.svg')}button.mastodon.svelte-z5oo5j{mask-image:url('/images/icons/b_mastodon.svg');-webkit-mask-image:url('/images/icons/b_mastodon.svg')}button.close.svelte-z5oo5j{mask-image:url('/images/icons/b_close.svg');-webkit-mask-image:url('/images/icons/b_close.svg')}button.right-arrow.svelte-z5oo5j{mask-image:url('/images/icons/b_arrow_r.svg');-webkit-mask-image:url('/images/icons/b_arrow_r.svg')}button.left-arrow.svelte-z5oo5j{mask-image:url('/images/icons/b_arrow_l.svg');-webkit-mask-image:url('/images/icons/b_arrow_l.svg')}button.back-circle.svelte-z5oo5j{background:none;background-image:url('/images/icons/b_back_circle.svg')}",
  map: null
};
const IconButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="${escape(type) + " " + escape(size) + " svelte-z5oo5j"}" style="${"--color: " + escape(color2) + ";"}"${add_attribute("title", title, 0)}></button>`;
});
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="${"svelte-1kxjoq3"}">${validate_component(IconLink, "IconLink").$$render($$result, { type: "youtube", color }, {}, {})}
