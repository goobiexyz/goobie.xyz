	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/graciebot/output-channels.js')
			},
			{
				type: 'endpoint',
				...
				names: ["fileName"],
				types: [null],
				load: () => import('./entries/endpoints/api/uploads/_fileName_.ts.js')
			},
			{
				type: 'endpoint',
				id: "api/posts",
				...
				names: [],
				types: [],
				load: () => import('./entries/endpoints/api/posts.ts.js')
			},
			{
				type: 'page',
				id: "art",
